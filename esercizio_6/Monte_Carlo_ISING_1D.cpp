...
void Welcome() // Welcome message
{
  ...
  if (restart==1) cout << "Restarting from previous configuration." << endl;
  else cout << "Generating infinite temperature configuration." << endl;
...
void Averages(int iblk) //Print results for current block
{
  ...
  if (metro==1) cout << accepted/attempted << endl << endl;
  else cout << "100% (Gibbs)" << endl << endl;
