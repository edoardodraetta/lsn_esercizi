...
void Averages(int iblock){ // compute averages
  ...
  pot << iblock << " " << setprecision(pr) << v << " " << setprecision(pr) << err_pot << endl;
  pot.close();
  ...
  kin << iblock << " " << setprecision(pr) << k << " " << setprecision(pr)  << err_kin << endl;
  kin.close();
  ...
  etot << iblock << " " << setprecision(pr) << e << " " << setprecision(pr) << err_etot << endl;
  etot.close();
  ...
  temp << iblock << " " << setprecision(pr) << t << " " << setprecision(pr) << err_temp << endl;
  temp.close();
